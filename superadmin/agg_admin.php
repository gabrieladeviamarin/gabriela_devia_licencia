...
if (isset($_GET['id']) && isset($_GET['nom'])) {
    ...
    echo "<script>alert('No se ha seleccionado ninguna empresa');</script>";
...
if (isset($_POST['submit'])) {
    ...
    if ($usuario) {
        ...
        $sql->execute();
        echo "<script>alert('Administrador asignado correctamente');</script>";
        echo "<script>window.location = 'index.php';</script>";
    }
}
?>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4">Asignar administrador a <?php echo $nombre_empresa?></h2>
                        ...
                        <form action="" id="form" method="POST" autocomplete="off">
                            ...
                            <button type="submit" id="submit" name="submit" class="btn btn-primary w-100">Asignar</button>
