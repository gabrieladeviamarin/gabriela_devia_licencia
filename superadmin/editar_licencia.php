...
$sql = $con->prepare("SELECT * FROM tipo_licencia WHERE id_tipo_licencia = $id_licencia ");
$sql->execute();
...
if (isset($_POST['actualizar'])) {
    ...
    $sql = $con->prepare("UPDATE tipo_licencia SET nombre_tipo_licencia = '$nombre_tipo_licencia', tipo_duracion = '$tipo_duracion', duracion = '$duracion', descripcion = '$descripcion', precio = $precio WHERE id_tipo_licencia = $id_licencia");
    $sql->execute();
    echo "<script>alert('Licencia actualizada correctamente');</script>";
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4">Editar licencia</h2>

                        <form method="POST">
                            <div class="mb-3">
                                <label for="nombre_tipo_licencia" class="form-label">Nombre licencia</label>
                                <input type="text" class="form-control" id="nombre_tipo_licencia" name="nombre_tipo_licencia" value="<?php echo $licencia['nombre_tipo_licencia']?>" placeholder="EJ: Licencia Demo, Licencia 1 año, Licencia 2 años" required>
                            </div>
                            <div class="mb-3">
                                <label for="tipo_duracion" class="form-label">Tipo de duracion</label>
                                <input type="text" class="form-control" id="tipo_duracion" name="tipo_duracion" value="<?php echo $licencia['tipo_duracion']?>" placeholder="EJ: dias, años " required>
                            </div>
                            <div class="mb-3">
                                <label for="duracion" class="form-label">Tiempo de duracion</label>
                                <input type="text" class="form-control" id="duracion" name="duracion" value="<?php echo $licencia['duracion']?>" placeholder="EJ: 1, 2 " required>
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">Descripcion</label>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo $licencia['descripcion']?>" placeholder="Duracion de la licencia y su descripcion" required>
                            </div>
                            <div class="mb-3">
                                <label for="precio" class="form-label">Precio</label>
                                <input type="text" class="form-control" id="precio" name="precio" value="<?php echo $licencia['precio']?>" required>
                            </div>
